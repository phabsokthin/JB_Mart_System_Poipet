...
interface SelectDropdownProps {
    ...
    placeholder: string;
    onSelectdata: (data: Data) => void;
    selectedValue?: number; // Optional selected value for update
}
...
const SelectDropdown: React.FC<SelectDropdownProps> = ({
    ...
    // Preload the selected supplier if `selectedValue` is provided
    useEffect(() => {
        if (selectedValue) {
            const preSelected = data.find((item) => item.supplierId === selectedValue);
            if (preSelected) {
