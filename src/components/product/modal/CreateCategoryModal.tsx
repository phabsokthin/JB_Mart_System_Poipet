...
function CreateCategoryModal({ onClose, fetchData, onSuccess, dataUpdate }: { onClose: () => void, fetchData: () => void, onSuccess: (message: string) => void, dataUpdate: dataUpdate | any }) {
    ...
    const handleSubmit = async (event: any) => {
        ...
        try {
            ...
            if (!dataUpdate) {
                ...
                const response = await axios.put(`${url}category/${dataUpdate.categoryId}`, data);
                if (response.data.msg) {
        ...
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
            ...
            >
                <div className="flex items-center gap-2 my-4 font-NotoSansKhmer">
                    ...
                    <h2 className="text-lg font-bold">{dataUpdate ? 'កែប្រែទំនិញ' : 'បង្កើតទំនិញថ្មី'}</h2>
                </div>
                <form onSubmit={handleSubmit}>
                    <div className="mb-4 space-y-2">
                        ...
                        <input
                            ...
                            required
                            className="input_text" placeholder="ឈ្មោះទំនិញ"
                        />
                    </div>
                    <div className="mb-4 space-y-2">
