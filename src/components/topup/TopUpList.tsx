    ...
    return (
        <div className="supplier-list">
            <div className="flex items-center gap-2 mb-3 ">
                ...
                <p className="font-bold font-NotoSansKhmer ">តារាងរាយបញ្ជីទិញកាតទូរស័ព្ទ</p>
            </div>
            <div className="flex justify-end">

                <button onClick={handleCreateNew} className="button_only_submit">+ បង្កើតការទិញផលិតផល</button>
            ...
            <div className="flex items-center justify-between my-3">
                ...
                <div>
                    <input type="text" className="input_text w-[300px]" placeholder="ស្វែងរកផលិតផល..." />
                </div>
            </div>
